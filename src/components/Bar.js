...
function Bar() {
    return(
      ...
      <div className="container" style={{marginTop:'2.5px'}}>
        ...
        <div className="contact-container" style={{marginLeft:'auto'}}>
            
            <div className="contacts">
                
            <div className="icon-box">
                    
                        <a title="Whatsapp" href="https://wa.me/543541532673" style={{color:'white'}}>
                ...
                <div className="icon-box">
                 ...
                 <a title="Instagram" href="https://www.instagram.com/color.tattoo.ink/" style={{color:'white'}}>
